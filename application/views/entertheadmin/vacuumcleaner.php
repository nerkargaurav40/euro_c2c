...
<h2 class="">Vacuum Cleaner Data</h2>
<?php echo form_open(ADMIN_FOLDER_NAME . '/vacuumcleaner', array('id' => 'frm_waterpurifier', 'class' => '', 'role' => 'form')) ?>
        ...
        <table class="table table-striped">
            ...
            <tbody>
               <?php 
                    ...
                    {
                        $result = $this->db->get_where('tbl_customer_answers',array('custID' => $value->custID,'empID'=>$value->empId,'questionCategory' => '2'))->result_array();
                        if(!empty($result)){
                ?>
                        <tr>
                        <td><?php echo $cnt; ?></td>
                        ...
                        <?php 
                            ...
                            {
                                $response = $this->db->get_where('tbl_customer_answers',array('custID' => $value->custID,'empID'=>$value->empId,'questionCategory' => '2','questionTxt' => $v['questionTxt']))->row_array();
...
<script>
    ...
    $(document).on('click','.btn_download',function(){
        ...
        window.location.href=b_url+'entertheadmin/downloadCategoryExcel?category=2&date_to='+date_to+'&date_from='+date_from;
